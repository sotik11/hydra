...
// Local patch (see DESIGN.md UB-1, PR hydralauncher/hydra#2452): handle
// external-resources failures at the callsites so a CDN outage neither
// replaces already-loaded metadata nor leaves the failure untraced.
// Remove when upstream PR merged.
